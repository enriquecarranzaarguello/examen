    ...
    <section className={styles.thankyou}>
      ...
      <div className={styles.thankyou__content}>
        ...
        <div className={styles.thankyou__content__info}>
          <h1>{t('marketing.course.payment.thankyou')}</h1>
          <p>{t('marketing.course.payment.moreDetails')}</p>
          <div className={checkButtonsWL}>
            <Link href="/marketing/course-flyway">
              <span>{t('marketing.course.payment.goCourses')}</span>
            </Link>
            <Link href="/">
              <span>{t('marketing.course.payment.goHome')}</span>
            </Link>
          </div>
        </div>
      </div>
