      ...
      <div className="px-5 py-[0.875rem] grid grid-cols-6 items-center text-white">
        <div className="justify-self-start flex gap-3 items-center col-span-5">
          {agentPhoto ? (
            ...
            <Image src={userDef} width={32} height={32} alt={'agent photo'} />
          )}
        ...
        {privateProfile ? (
          <Dropdown
            title={
              <Image alt="icon" src={threeDotsIcon} className="" width={6.5} />
            }
      ...
      <Swiper
        ...
        onSlideChangeTransitionEnd={swiper => {
          ...
          if (currentIndex > previousIndex) {
            ...
            // Swiped left
            const newIndex = imageIndex - 1;
            setImageIndex(newIndex === -1 ? post.images.length - 1 : newIndex);
          }
        }}
      >
        {post.images ? (
