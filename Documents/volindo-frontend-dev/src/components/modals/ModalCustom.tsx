...
export default function ModalCustom({ open, onClose, text }: ModalCustomProps) {
  if (!open) return null;
  ...
  return (
    <div
      ...
      onClick={onClose}
    >
      <div className="relative md:max-w-[700px] bg-[#141416] shadow-[0px_64px_64px_-48px_rgba(15,15,15,0.08)] rounded-[16px] p-10 text-center">
